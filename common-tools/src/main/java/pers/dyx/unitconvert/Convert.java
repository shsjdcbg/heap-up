package pers.dyx.unitconvert;

import pers.dyx.unitconvert.defs.DefEnumItf;
import pers.dyx.unitconvert.defs.Length;
...
public class Convert {
    ...
    public static void main(String[] args) {
        BigDecimal result = Convert.from(Length.KM).to(Length.M).setAccuracy(0).calculate(new BigDecimal(1));
