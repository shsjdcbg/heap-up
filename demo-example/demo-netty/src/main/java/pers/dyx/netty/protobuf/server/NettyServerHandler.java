...
import pers.dyx.netty.protobuf.protobuf.UserInfo;
import pers.dyx.netty.protobuf.protobuf.UserInfo.UserMsg;
...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        UserInfo.UserMsg userMsg = UserMsg.newBuilder().setId(1).setAge(18).setName("xuwujing").setState(0)
                .build();
